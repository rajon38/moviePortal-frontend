    ...
    <Card className="w-full max-w-md mx-auto shadow-md">
      ...
      <CardContent>
        ...
        <Button variant="outline" className="w-full" onClick={() => {
          ...
          window.location.href = `${baseUrl}/auth/login/google?redirect=${encodeURIComponent(nextRedirect)}`;
        ...
        {oauthError && (
          <Alert variant={"destructive"} className="mt-4">
            <AlertDescription>Google login failed: {oauthError}</AlertDescription>
          </Alert>
        )}
      </CardContent>
